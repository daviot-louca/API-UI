...
const { loginController, createAuth, allUsers, deleteAll, deleteUser, updateUsers,rechercheUsers,modifierUsers,modifierMotDePasse,countUsers } = require('../controllers/auth.controller');
